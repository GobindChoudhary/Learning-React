  ...
  return (
    <div className="h-[8vh] relative flex items-center justify-start pl-[15%]">
      ...
      <input
        ...
        value={query}
        className="w-[45%]   mx-6 h-[90%] text-zinc-200 p-5 text-lg outline-none border-none bg-transeparent "
        type="text"
      ...
      <div className=" absolute w-[50%] max-h-[50vh] border-zinc-300 bg-zinc-200 top-[90%] overflow-auto">
        {search.map((s, i) => (
          <Link
            key={i}
